'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src/TabViewPagerPan.js';var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();

var _react=require('react');var _react2=_interopRequireDefault(_react);
var _propTypes=require('prop-types');var _propTypes2=_interopRequireDefault(_propTypes);var _Animated=require('react-native-web/dist/exports/Animated');var _Animated2=_interopRequireDefault(_Animated);var _PanResponder=require('react-native-web/dist/exports/PanResponder');var _PanResponder2=_interopRequireDefault(_PanResponder);var _Platform=require('react-native-web/dist/exports/Platform');var _Platform2=_interopRequireDefault(_Platform);var _StyleSheet=require('react-native-web/dist/exports/StyleSheet');var _StyleSheet2=_interopRequireDefault(_StyleSheet);
...
timing:_Animated2.default.spring,
tension:300,
friction:35};var
...
_isMovingHorizontally=function(evt,gestureState){
return(
...
_getNextIndex=function(evt,gestureState){
var currentIndex=
...
var canMove=
_this._isMovingHorizontally(evt,gestureState)&&(
...
_startGesture=function(evt,gestureState){
...
var currentPosition=
typeof _this._lastValue==='number'?
_this._lastValue:
_this.props.navigationState.index;
var nextPosition=
...
_transitionTo=function(toValue){
...
var transitionSpec=_this.props.configureTransition(
currentTransitionProps,
nextTransitionProps);var

timing=transitionSpec.timing,transitionConfig=_objectWithoutProperties(transitionSpec,['timing']);

timing(_this.props.position,_extends({},
transitionConfig,{
toValue:toValue})).
...
return(
_react2.default.createElement(_Animated2.default.View,_extends({
style:[
styles.sheet,
width?
...
this._panResponder.panHandlers,{__source:{fileName:_jsxFileName,lineNumber:290}}),

_react.Children.map(children,function(child,i){return(
_react2.default.createElement(_TabviewPagerPanChildren2.default,{key:navigationState.routes[i].key,
testID:navigationState.routes[i].testID,navigationState:navigationState,width:width,child:child,i:i,__source:{fileName:_jsxFileName,lineNumber:300}}));})));



}}]);return TabViewPagerPan;}(_react.PureComponent);TabViewPagerPan.propTypes=_extends({},_TabViewPropTypes.SceneRendererPropType,{configureTransition:_propTypes2.default.func.isRequired,animationEnabled:_propTypes2.default.bool,swipeEnabled:_propTypes2.default.bool,swipeDistanceThreshold:_propTypes2.default.number.isRequired,swipeVelocityThreshold:_propTypes2.default.number.isRequired,onSwipeStart:_propTypes2.default.func,onSwipeEnd:_propTypes2.default.func,children:_propTypes2.default.node});TabViewPagerPan.defaultProps={configureTransition:function configureTransition(){return DefaultTransitionSpec;},initialLayout:{height:0,width:0},swipeDistanceThreshold:120,swipeVelocityThreshold:0.25};exports.default=TabViewPagerPan;
